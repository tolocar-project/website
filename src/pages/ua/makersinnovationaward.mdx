...
<div class="bg-tolo-green w-full text-white">
  <div class="container-width grid grid-cols-1 md:grid-cols-12 gap-x-16 gap-y-2 md:gap-y-24 py-8 md:py-24">
    ...
    <div class="col-span-1 md:col-span-7 font-semibold font-aktiv text-2xl">
      ...
      <p class="mb-8">Прийом заявок завершиться 9 лютого о 16:00 (Східноєвропейський час).<br/><br/>
      Будь ласка, ознайомтеся з умовами та положеннями <u><a href="https://drive.google.com/file/d/1M858wFWn2QR5KI-ZSAa37TCy0pUTyBy1/view?usp=sharing">тут</a></u>.<br/><br/>
      Нижче наведено основні критерії відбору ваших проєктних ідей:</p>
    </div>
