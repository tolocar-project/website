...
<div class="container-width grid md:grid-cols-12 p-0 md:pt-24">
  <HeadlineUnderlined large variant={12} className="pt-10 pb-8 sm:py-0 md:col-span-8 mb-10">Читати практичний посібник</HeadlineUnderlined>
    <iframe width="100%" height="800px" className="w-full col-span-1 md:col-span-12 h-96 md:h-[800px]" src="/pdfjs/web/viewer.html?file=/playbook/HowToTolocar_Playbook_UA_ES.pdf#page=1&zoom=auto&pagemode=none"></iframe>
</div>
