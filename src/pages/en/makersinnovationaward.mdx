...
<div class="container-width grid grid-cols-1 md:grid-cols-12 gap-8 py-8 md:py-24">
  ...
  <div className="col-span-1 md:col-span-5">
    <TextBlock>
      ...
      **Application for the workshop is closed. Registration for the Online Follow Up Sessions as well as the Final Project Application will open on January 12.**
    </TextBlock>
  </div>
</div>
