...
<div class="bg-tolo-green w-full text-white">
  <div class="container-width grid grid-cols-1 md:grid-cols-12 gap-x-16 gap-y-2 md:gap-y-24 py-8 md:py-24">
    ...
    <div class="col-span-1 md:col-span-7 font-semibold font-aktiv text-2xl">
      <ButtonLink caption="Apply now" target="https://forms.gle/X5S7rbqZsmDSwoFS9" variant="dark" className="mt-8" newTab /><br/><br/>
      <p class="mb-8">Application will close on February 9th, 4 pm (EET).<br/><br/>
      Check out the <u><a href="https://thoughtful-hiss-0d9.notion.site/MIA-FAQ-ENG-05fbb555509146a189aa56767fd50b70">FAQ</a></u>.<br/><br/>
