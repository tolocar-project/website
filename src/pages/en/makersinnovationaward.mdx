...
<div class="container-width grid grid-cols-1 md:grid-cols-12 gap-8 py-8 md:py-24">
  <div class="col-span-1 md:col-span-12">
    ...
    >
      Idea Cultivation Workshop (January 19th)
    </h2>
  </div>
  ...
  <div className="col-span-1 md:col-span-5">
    <TextBlock>
      ...
      Application for the workshop is closed.
    </TextBlock>
  </div>
</div>
...
<div class="bg-tolo-green w-full text-white">
  <div class="container-width grid grid-cols-1 md:grid-cols-12 gap-x-16 gap-y-2 md:gap-y-24 py-8 md:py-24">
    ...
    <div class="col-span-1 md:col-span-7 font-semibold font-aktiv text-2xl flex flex-col gap-4">
      ...
      <p>Fill in the google form for <a className="underline" href="https://docs.google.com/forms/d/e/1FAIpQLSfICT3UUCSy6XhrvpsgN6o-Dg3pWasBZnZaY8O9ayuEWeICeQ/viewform" target="_blank">the 1st virtual training session</a> and for <a className="underline" href="https://docs.google.com/forms/d/e/1FAIpQLScUlOsR3sLiDZEs1xsUIGPeC42qPbZie5ZbN5N3euiq33Te3Q/viewform" target="_blank"> the Q&A session</a>.</p>
      ...
      <p>Please find the main selection criteria for your project ideas below:</p>
    </div>
