...
<SideBySide className="mt-8 mb-20 sm:mt-20">
  <HeadlineUnderlined variant={9} className="flex-[2]">The Tolocar project sends mobile makerspaces into Ukraine to help, train and equip local communities.</HeadlineUnderlined>
