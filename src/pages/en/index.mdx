...
<HeroImage />
<SideBySide className="mt-8 mb-20 sm:mt-20">
  <HeadlineUnderlined variant={9} className="flex-[2] leading-6 lg:leading-8">
...
<ContentSection variant="white" id="what-is-a-tolocar">
  <HeadlineUnderlined large variant={6} className="container-width leading-10 mt-8 sm:mt-20">What is a Tolocar?</HeadlineUnderlined>
...
<ContentSection variant="dark">
  ...
  <div class="container-width flex lg:justify-end bg-illustration-2-dark bg-no-repeat lg:bg-[position:left_0px_top_135px]"> 
      <div class="lg:w-10/12">
      <ImageGrid images={["images/roof.jpg", "images/cars/image3.jpg"]} caption="Photos: @ Nika Popova."/>
  ...
  <div class="container-width flex lg:justify-start mt-8 sm:mt-14 mb-16">
    <div class="flex flex-col lg:w-10/12 ">
      <div class="flex flex-col lg:flex-row custom-prose text-lg leading-6 gap-8 mb-12 lg:mb-16">
        <div class="flex-1">
          <p class="text-2xl leading-8 font-bold text-tolo-black">With our Tolocars we operate directly in Ukraine.</p>
