...
<ContentSection variant="dark">
  ...
  <div class="container-width flex lg:justify-end bg-illustration-2-dark bg-no-repeat lg:bg-[position:left_0_top_135px]"> 
      ...
      <ImageGrid images={["images/outdoor.jpg", "images/cars/bootcamp.jpg"]} caption="Photos: Kateryna Pereverzeva (l), Kostyantyn Leonenko (r)."/>
  ...
  <div className="container-width flex lg:justify-end">
    ...
    <ImpactListItem tagIcon="parachute" title="Capacity Development" text="We promote capacity development and organizational development to accelerate the impact of Ukrainian makerspaces. " />
...
<ContentSection variant="dark">
  ...
  <div className="container-width flex lg:justify-end">
    ...
    <ImpactListItem tagIcon="parachute" title="Diversity and Inclusion" text="We pay particular attention to groups in need of special protection." />
