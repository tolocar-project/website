...
<SideBySide className="mt-2 mb-20 sm:mt-20">
  <HeadlineUnderlined variant={9} className="flex-[2] pt-10 pb-8 sm:py-0">The Tolocar project sends mobile makerspaces into Ukraine to help, train and equip local communities.</HeadlineUnderlined>
