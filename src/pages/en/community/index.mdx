...
<ContentSection variant="white" id="partners">
    ...
    <div className="container-width grid grid-cols-1 gap-6 md:grid-cols-2  lg:grid-cols-3">
        ...
        <CommunityGridCard img="images/logos/metalab.png" title="METALAB" text="MetaLab is a city development laboratory that supports a socially equal, spatially comfortable, culturally rich, environmentally responsible, economically balanced city (environment)." target="www.metalab.space"/>
