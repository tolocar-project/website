...
<ContentSection variant="white" id="partners">
    ...
    <div className="container-width grid grid-cols-1 gap-6 md:grid-cols-2  lg:grid-cols-3">
        ...
        <CommunityGridCard img="images/logos/hiww.svg" title="HIWW" text="HIWW is a German technology institute focused on open production, innovation and knowledge. It is leading the project in its current phase." target="www.hiww.de"/>
