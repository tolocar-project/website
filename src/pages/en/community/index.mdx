...
<ContentSection variant="white" id="partners">
    ...
    <div className="container-width grid grid-cols-1 gap-6 md:grid-cols-2  lg:grid-cols-3">
        ...
        <CommunityGridCard img="images/logos/giz-logo.png" title="GIZ" text="The Deutsche Gesellschaft für internationale Zusammenarbeit (GIZ) GmbH implemented the project." target="www.giz.de"/>
        <CommunityGridCard img="images/logos/HIWW.png"title="HIWW" text="HIWW is German technology institute which focus on open production, innovation and knowlege. It manages the project in it's current phase." target="www.hiww.de"/>
