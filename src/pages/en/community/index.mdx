...
<ContentSection variant="white" id="maker-initiatives">
    ...
    <div className="container-width grid grid-cols-1 gap-6 md:grid-cols-2  lg:grid-cols-3">
        ...
        <CommunityGridCard img="images/logos/logo-iopalliance.svg" title="Internet of Production" text="An initiative for sustainable, globally networked, local manufacturing." target="www.internetofproduction.org" url="www.internetofproduction.org"/>
