...
<ContentSection variant="white" id="partners">
    ...
    <div className="container-width grid grid-cols-1 gap-6 md:grid-cols-2  lg:grid-cols-3">
        ...
        <CommunityGridCard img="images/logos/insha-osvita.png" title="betterplace lab" text="A digital-social think-and-do tank focusing on digitalization for the common good innovation for digital transformation conducting research, workshops and organizing events." target="https://www.betterplace-lab.org/"/>
        <CommunityGridCard img="images/logos/Ostriv.png" title="Future Challenges e.V." text="A non-profit organization dedicated to building ecosystems for human rights actors fostering digital transformation in the field of human rights empowering co-creative, sustainable, and digital mindsets." target="https://futurechallenges.org/"/>
        <CommunityGridCard img="images/logos/gig.png" title="Maker Hub NGO" text="The Maker Hub develops zero-to-maker and maker-to-business pipelines by providing small and big events for makers, such as meetups and Maker Faires, and publishing manuals and playbooks for makerspaces." target="https://makerhub.org"/>
