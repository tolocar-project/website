...
<ContentSection variant="white" id="partners">
    ...
    <div className="container-width grid grid-cols-1 gap-6 md:grid-cols-2  lg:grid-cols-3">
        ...
        <CommunityGridCard img="images/logos/insha-osvita.png" title="betterplace lab" text="A digital-social think-and-do tank focusing on digitalization for the common good innovation for digital transformation conducting research, workshops and organizing events." target="betterplace-lab.org"/>
