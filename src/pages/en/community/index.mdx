...
<ContentSection variant="white" id="labs">
    ...
    <div className="container-width grid grid-cols-1 gap-6 md:grid-cols-2  lg:grid-cols-3">
        ...
        <CommunityGridCard title="Makerhub" text="A makerspace in Kyiv which organised Kyiv Mini Maker Faire, Odesa Mini Maker Faire, Raspberry Jam's, Maker BBQ etc." target="https://makerhub.org"/>
    </div>
</ContentSection>
